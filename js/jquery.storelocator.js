...
/*jQuery Google Maps Store Locator - v2.0.8*/
...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'infowindowTemplatePath'   : '../wp-content/themes/subway-clone/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'         : '../wp-content/themes/subway-clone/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath': '../wp-content/themes/subway-clone/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'      : '../wp-content/themes/subway-clone/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'           : null,
	...
	$.extend(Plugin.prototype, {
		...
		var options = {
		 ...
		 var addressID = (document.getElementById('bh-sl-address'));
		 var autocomplete = new google.maps.places.Autocomplete(addressID, options);
		...
		processData: function (mappingObject, originPoint, data, page) {
			...
			$(document).on('click.'+pluginName, '.' + _this.settings.locationList + ' li', function () {
				...
				google.maps.event.addDomListener(window, 'resize', function() {
				var center = selectedMarker.getPosition();
				google.maps.event.trigger(map, 'resize');
				map.setCenter(center);
				});
